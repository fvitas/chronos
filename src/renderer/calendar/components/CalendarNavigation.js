...
class CalendarNavigation extends Component {
    ...
    showContextMenu = (event) => {
        ...
        ipcRenderer.send('show-context-menu', { x: left, y: top })
    }
        ...
        return (
            <Fragment>
                <header className='App-header'>
                    ...
                    <svg className='clickable today' viewBox='0 0 448 512' width='22' fill='white' onClick={this.onToday}>
                    ...
                    <svg className='clickable' viewBox='0 0 512 512' width='24px' fill='white' onClick={this.showContextMenu}>
